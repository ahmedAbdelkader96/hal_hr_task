  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        SizedBox(height: MQuery.getheight(context, 8)),
        const Text(
        ...
        SizedBox(height: MQuery.getheight(context, 24)),
        ...
        SizedBox(height: MQuery.getheight(context, 50)),
        BlocConsumer<AuthenticationBloc, AuthenticationState>(
          ...
          builder: (context, state) {
            return GeneralRawMaterialButton(
              ...
              child:
                  state is LoadingToSignInWithEmailAndPasswordState
